...
class SearchBloc extends Bloc<SearchEvent, SearchState> {
  SearchBloc({
    ...
    required ToggleLikeUseCase togglePostLikeUseCase,
  ...
  final ToggleLikeUseCase _togglePostLikeUseCase;
  ...
  Future<void> _onSearchExecutionTriggered(
    ...
    if (currentTabIndex == 0) {
      ...
      emit(state.copyWith(status: SearchStatus.loadingPost, posts: []));
  ...
  Future<void> _onSearchPostLikeToggled(
    ...
    final result = await _togglePostLikeUseCase(originalPost.postId);
